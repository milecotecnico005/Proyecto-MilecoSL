<?php $__env->startSection('title', 'Partes de trabajo'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="tableCard" class="card">
        ...
        <button type="button" style="max-width: 200px" data-partes="<?php echo e(json_encode($partes_trabajo)); ?>" class="btn btn-success d-none" id="confirmVentaModal"></button>
    ...
    <?php $__env->startComponent('components.modal-component', [
        ...
        <form id="formCreateOrden" action="<?php echo e(route('admin.ordenes.createOrderByParte')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select id="material_id" name="material_id" class="form-select">
                        <?php $__currentLoopData = $articulosTodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php $__env->startComponent('components.modal-component', [
        ...
        <form
            action="<?php echo e(route('admin.partes.generateReport')); ?>"
            method="POST"
...
<?php $__env->startSection('js'); ?>
    <script>
        $(document).ready(function() {
            ...
            const partes = <?php echo json_encode($partes_trabajo, 15, 512) ?>;
            ...
            function openDetailsOrdersTrabajoModal(ordenIdSend){
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.ordenes.showApi')); ?>",
                    method: 'POST',
                    data: {
                        ordenId,
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select articulo" id="articulo_id${materialCounter}" name="articulo_id" required>
                                        ...
                                        <?php $__currentLoopData = $articulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option data-namearticulo="<?php echo e($articulo->nombreArticulo); ?>" value="<?php echo e($articulo->idArticulo); ?>">
                                                <?php echo e($articulo->nombreArticulo); ?> | <?php echo e(formatTrazabilidad($articulo->TrazabilidadArticulos)); ?> | <?php echo e($articulo->stock->cantidad); ?>
            ...
            $('#btnCreateOrdenButton').on('click', function(event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.partes.store')); ?>",
                    method: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
                        ...
                        $('#confirmVentaModal').on('click', function (event){
                            ...
                            $('#confirmVentaModalMod #confirmVentaModalBtn').on('click', function(event) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        $.ajax({
                                        url: "<?php echo e(route('admin.ventas.ventaVarios')); ?>",
                                        method: 'POST',
                                        data: {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Clases_Programacion\Clientes\MILECOSL\milecosl\resources\views/admin/partes_trabajo/index.blade.php ENDPATH**/ ?>