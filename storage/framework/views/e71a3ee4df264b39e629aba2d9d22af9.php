    ...
    <section class="home section" id="home">
        <div class="home__container container grid">
            ...
            <div class="home__images">
                ...
                <div class="home__img">
                    <img src="<?php echo e(asset('img/home.jpg')); ?>" alt="Imagen Principal">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="logos section">
        <div class="logos__container container grid">
            <div class="logos__img">
                <img src="<?php echo e(asset('img/logo1.png')); ?>" alt="Logo de la Empresa 1">
            </div>
            <div class="logos__img">
                <img src="<?php echo e(asset('img/logo2.png')); ?>" alt="Logo de la Empresa 2">
            </div>
            <div class="logos__img">
                <img src="<?php echo e(asset('img/logo3.png')); ?>" alt="Logo de la Empresa 3">
            </div>
            <div class="logos__img">
                <img src="<?php echo e(asset('img/logo4.png')); ?>" alt="Logo de la Empresa 4">
            </div>
        </div>
    </section>
            ...
            <div class="popular__container grid swiper">
                <div class="swiper-wrapper">
                    <article class="popular__card swiper-slide">
                        <img src="<?php echo e(asset('img/popular1.jpg')); ?>" alt="Residencia Popular 1" class="popular__img">
                    ...
                    <article class="popular__card swiper-slide">
                        <img src="<?php echo e(asset('img/popular2.jpg')); ?>" alt="Residencia Popular 2" class="popular__img">
                    ...
                    <article class="popular__card swiper-slide">
                        <img src="<?php echo e(asset('img/popular3.jpg')); ?>" alt="Residencia Popular 3" class="popular__img">
                    ...
                    <article class="popular__card swiper-slide">
                        <img src="<?php echo e(asset('img/popular4.jpg')); ?>" alt="Residencia Popular 4" class="popular__img">
                    ...
                    <article class="popular__card swiper-slide">
                        <img src="<?php echo e(asset('img/popular5.jpg')); ?>" alt="Residencia Popular 5" class="popular__img">
        ...
        <div class="value__container container grid">
            <div class="value__images">
                ...
                <div class="value__img">
                    <img src="<?php echo e(asset('img/value.jpg')); ?>" alt="Imagen de Valor">
                </div>
            </div>
        ...
        <div class="contact__container container grid">
            <div class="contact__images">
                ...
                <div class="contact__img">
                    <img src="<?php echo e(asset('img/contact.png')); ?>" alt="Imagen de Contacto">
                </div>
            </div>
...
<?php echo $__env->make('layouts.clientlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\milecosl\resources\views/welcome.blade.php ENDPATH**/ ?>