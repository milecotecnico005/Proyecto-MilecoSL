                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <select name="cita" id="citasPendigSelect" class="form-select">
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option 
                                    data-asunto="<?php echo e($cita->name); ?>"
                                    data-fecha="<?php echo e($cita->start_date); ?>"
                                    data-estado="<?php echo e($cita->status); ?>"
                                    value="<?php echo e($cita->idProyecto); ?>">
                                    <?php echo e($cita->name); ?> | Fecha de Inicio: <?php echo e($cita->start_date); ?>
...
</script><?php /**PATH E:\Clases_Programacion\Clientes\MILECOSL\milecosl\resources\views/admin/partes_trabajo/form.blade.php ENDPATH**/ ?>