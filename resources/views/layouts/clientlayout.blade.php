        ...
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <div class="nav__menu">
                    <ul class="nav__list">
                        <li class="nav__item">
                            <a href="{{ route('index') }}#home" class="nav__link active-link">
                                <i class='bx bx-home-alt-2'></i>
                                <span>Inicio</span>
                            </a>
                        </li>
                        <li class="nav__item">
                            <a href="{{ route('index') }}#popular" class="nav__link">
                                <i class='bx bx-building-house' ></i>
                                <span>Nuestros trabajos</span>
                            </a>
                        </li>
                        <li class="nav__item">
                            <a href="{{ route('index') }}#value" class="nav__link">
                ...
                <div class="footer__content">
                    <div>
                        ...
                        <ul class="footer__links">
                            <li>
                                <a href="{{ route('politicas') }}" class="footer__link">Politicas de privacidad</a>
                            </li>
                        </ul>
                    </div>
