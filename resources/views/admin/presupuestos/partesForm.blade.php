            ...
            >
                ...
                <div class="form-row">
                    ...
                    <div style="max-width: 33%" class="form-group col-sm-6 col-md-4 required-field">
                        ...
                        <input type="text" class="form-control" id="horas_trabajadas" name="horas_trabajadas" value="0" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    @if (!isset($hideButtonSave))
                        <div class="form-group col-md-12 mt-2 d-flex justify-content-end">
                            <button type="button" class="btn btn-outline-warning" id="btnCreateOrdenButtonPresu">
